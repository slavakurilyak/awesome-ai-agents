...
- [ ] If this PR changes files under `skills/`, those changes are intentional and described below.

Using the skill is encouraged but not required. Contributions that follow `CONTRIBUTING.md` are welcome either way.
